...
urlpatterns = [
    ...
    path('posts/<int:post>/like/', views.postlike_list, name='postlike-list'),
    path('posts/<int:post>/like/new/', views.add_postlike, name='postlike-new'),
    path('posts/<int:post>/like/<int:pk>/', views.postlike_detail, name='postlike-detail'),
